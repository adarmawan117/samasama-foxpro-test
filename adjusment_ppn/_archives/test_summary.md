...
Date executed: 2026-06-18 08:47:04
...
- **Tier 1 (Feature Coverage)**: Passed 14 / 21
- **Tier 2 (Boundary/Edge)**: Passed 19 / 21
- **Tier 3 (Combination)**: Passed 2 / 5
- **Tier 4 (Real-world Scenarios)**: Passed 3 / 5
...
| TC-T1-09 | Tier 1 | Feature Coverage - Addition | Addition: Exact value matches and pulls Baju from savings. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Expected empty table, got 1 rows |
...
| TC-T1-11 | Tier 1 | Feature Coverage - Addition | Addition: pulls closest possible below target. Target is 15000, draws 1 Baju (10000). | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Row count mismatch: expected 1, got 2 |
...
| TC-T1-14 | Tier 1 | Feature Coverage - Addition | Addition: Drains available savings Baju x1 and inserts fictional Sabun x9. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Row count mismatch: expected 1, got 2 |
| TC-T1-15 | Tier 1 | Feature Coverage - Addition | Addition uses latest master price instead of historical transaction values. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Expected empty table, got 1 rows |
| TC-T1-16 | Tier 1 | Feature Coverage - Addition | Savings record is fully deleted from tabungan_dan_hutang when remaining qty is 0. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Expected empty table, got 1 rows |
...
| TC-T1-18 | Tier 1 | Feature Coverage - Global Gap | Global gap negative distribution (addition matching & remainder). | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Expected empty table, got 1 rows |
...
| TC-T1-21 | Tier 1 | Feature Coverage - Self-Healing | Self-healing on reduction: completely clears/deletes existing debt record. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Expected empty table, got 1 rows |
...
| TC-T2-14 | Tier 2 | Boundary/Edge - Receipt Details & Constraints | Negative qty in tabungan: script auto-corrects to absolute value during execution. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Expected empty table, got 2 rows |
...
| TC-T2-21 | Tier 2 | Boundary/Edge - Receipt Details & Constraints | Invoice with only non-PPN items under addition. Baju (PPN) is successfully added. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Expected empty table, got 1 rows |
...
| TC-T3-02 | Tier 3 | Combination - Sequences | Reduction targets 15000. INV01 has 2 Baju, gets reduced by 1. excess 5000 goes to global_gap. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Row count mismatch: expected 1, got 2 |
| TC-T3-03 | Tier 3 | Combination - Sequences | Addition target 10000: draws 3 Sabun (3000) from savings, then injects fictional Sabun x7 (7000). | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Row count mismatch: expected 1, got 2 |
...
| TC-T3-05 | Tier 3 | Combination - Sequences | Addition target creates negative global gap distributed, triggering self-healing of debt. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Expected empty table, got 1 rows |
...
| TC-T4-02 | Tier 4 | Real-world - Month Scenarios | Deficit Month: uses active savings to add PPN items to multiple transactions. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Row count mismatch: expected 2, got 3 |
...
| TC-T4-04 | Tier 4 | Real-world - Month Scenarios | Fluctuating month: reductions heal previous debts from multiple products. | ❌ FAIL | Target Table 'tabungan_dan_hutang' assertion failed: Row count mismatch: expected 2, got 3 |
