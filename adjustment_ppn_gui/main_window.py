...
class ProsesAdjustmentPajakApp(QMainWindow):
    ...
    def initUI(self):
        ...
        height = min(available_geom.height() - 80, 750)
        ...
        # Date range inputs
        self.tgl_awal = QDateEdit(QDate(2025, 8, 1))
        ...
        self.tgl_akhir = QDateEdit(QDate(2025, 8, 31))
        ...
        # Target PPN Input
        self.target_ppn_input = QLineEdit("1000000000")
        ...
        # Target BTKP Input
        self.target_btkp_input = QLineEdit("100000000")
